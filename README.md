# Android Project 6 - *BitFit v.2*

Submitted by: *Khanh Tra Nguyen Tran**

**BitFit v.2** is a health metrics app that allows users to track the sleeping hours and the mood of the users 
...
I have trouble with the notification part.
